                        ...
                        <div
                          ...
                          className={`border-2 border-dashed rounded-lg p-4 sm:p-5 text-center cursor-pointer transition-colors ${
                            headshotDropzone.isDragActive
                              ...
                              : "border-white/25 hover:border-amber-400"
                          }`}
                        >
              ...
              <div className="rounded-3xl p-6 sm:p-10 bg-slate-900/85 backdrop-blur-lg border border-white/15 text-center">
                ...
                <div className="mt-7 flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className="w-full px-8 py-3.5 rounded-full bg-white/10 border border-white/20 text-white font-semibold text-base hover:bg-white/20 transition-colors"
                  >
